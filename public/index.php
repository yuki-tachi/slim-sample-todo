...
$app->group('/todo/api', function (RouteCollectorProxy $group) {
    ...
    $group->post('/delete/{id}', function (Request $request, Response $response, array $args) {
        ['id' => $id] = $args;
...
$app->get('/hello/{msg}', function (Request $request, Response $response, $args) {
    $msg = $args['msg'];
    $response->getBody()->write("request(/hello/{msg}) msg==$msg");
